...
end, arity = 0, grammar = Calc, name = 'exp'}), addexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = Calc, name = 'addexp'}), mulexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = Calc, name = 'mulexp'}), primexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
if not (input:applyWithArgs(input.grammar.exactly, '(')) then
return false
end
...
end, arity = 0, grammar = Calc, name = 'primexp'}), numstr = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = Calc, name = 'numstr'})})
...
end, arity = 0, grammar = EvalCalc, name = 'exp'}), addexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local r, __pass__, l
...
end, arity = 0, grammar = EvalCalc, name = 'addexp'}), mulexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local r, __pass__, l
...
end, arity = 0, grammar = EvalCalc, name = 'mulexp'}), primexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = EvalCalc, name = 'primexp'}), numstr = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = EvalCalc, name = 'numstr'})})
...
end, arity = 0, grammar = TableTreeCalc, name = 'exp'}), addexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local r, __pass__, l
__pass__, l = input:apply(input.grammar.addexp)
if not (__pass__) then
...
end, arity = 0, grammar = TableTreeCalc, name = 'addexp'}), mulexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local r, __pass__, l
__pass__, l = input:apply(input.grammar.mulexp)
if not (__pass__) then
...
end, arity = 0, grammar = TableTreeCalc, name = 'mulexp'}), primexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local __result__, __pass__
if not (input:applyWithArgs(input.grammar.exactly, '(')) then
return false
...
end, arity = 0, grammar = TableTreeCalc, name = 'primexp'}), numstr = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
return input:applyWithArgs(input.grammar.toNumber, function (input)
return input:applyWithArgs(input.grammar.consumed, function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = TableTreeCalc, name = 'numstr'})})
...
end, arity = 0, grammar = OpTreeCalc, name = 'exp'}), addexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local r, __pass__, l
__pass__, l = input:apply(input.grammar.addexp)
if not (__pass__) then
...
end, arity = 0, grammar = OpTreeCalc, name = 'addexp'}), mulexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local r, __pass__, l
__pass__, l = input:apply(input.grammar.mulexp)
if not (__pass__) then
...
end, arity = 0, grammar = OpTreeCalc, name = 'mulexp'}), primexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local __result__, __pass__
if not (input:applyWithArgs(input.grammar.token, "(")) then
return false
...
end, arity = 0, grammar = OpTreeCalc, name = 'primexp'}), numstr = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = OpTreeCalc, name = 'numstr'}), special = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
return input:applyWithArgs(input.grammar.exactly, '+')
end, function (input)
return input:applyWithArgs(input.grammar.exactly, '-')
...
end, arity = 0, grammar = OpTreeCalc, name = 'special'})})
...
end, arity = 0, grammar = MixedOTCalc, name = 'primexp'}), numstr = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
return input:apply(input.grammar.number)
end, function (input)
return input:apply(OpTreeCalc.numstr)
end)
end, arity = 0, grammar = MixedOTCalc, name = 'numstr'}), eval = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local opr, __pass__
...
end, arity = 0, grammar = MixedOTCalc, name = 'eval'}), add = OMeta.Rule({behavior = function (input)
...
end, arity = 0, grammar = MixedOTCalc, name = 'add'}), sub = OMeta.Rule({behavior = function (input)
local right, left, __pass__
return input:applyWithArgs(input.grammar.choice, function (input)
if not (input:applyWithArgs(input.grammar.object, nil, function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = MixedOTCalc, name = 'sub'}), mul = OMeta.Rule({behavior = function (input)
local right, left, __pass__
return input:applyWithArgs(input.grammar.choice, function (input)
if not (input:applyWithArgs(input.grammar.object, nil, function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = MixedOTCalc, name = 'mul'}), div = OMeta.Rule({behavior = function (input)
local right, left, __pass__
return input:applyWithArgs(input.grammar.choice, function (input)
if not (input:applyWithArgs(input.grammar.object, nil, function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = MixedOTCalc, name = 'div'}), unknown = OMeta.Rule({behavior = function (input)
...
end, arity = 0, grammar = MixedOTCalc, name = 'unknown'})})
...
end, arity = 0, grammar = AstCalc, name = 'exp'}), addexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local r, __pass__, l
__pass__, l = input:apply(input.grammar.addexp)
if not (__pass__) then
...
end, arity = 0, grammar = AstCalc, name = 'addexp'}), mulexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local r, __pass__, l
__pass__, l = input:apply(input.grammar.mulexp)
if not (__pass__) then
...
end, arity = 0, grammar = AstCalc, name = 'mulexp'}), primexp = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local __result__, __pass__
if not (input:applyWithArgs(input.grammar.token, "(")) then
return false
...
end, arity = 0, grammar = AstCalc, name = 'primexp'}), numstr = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
if not (input:applyWithArgs(input.grammar.many, input.grammar.ws)) then
return false
end
...
end, arity = 0, grammar = AstCalc, name = 'numstr'}), special = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
return input:applyWithArgs(input.grammar.exactly, '+')
end, function (input)
return input:applyWithArgs(input.grammar.exactly, '-')
...
end, arity = 0, grammar = AstCalc, name = 'special'})})
...
end, arity = 0, grammar = MixedAstCalc, name = 'primexp'}), numstr = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
return input:apply(input.grammar.number)
end, function (input)
return input:apply(AstCalc.numstr)
end)
end, arity = 0, grammar = MixedAstCalc, name = 'numstr'}), eval = OMeta.Rule({behavior = function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
local opr, __pass__
__pass__, opr = input:applyWithArgs(input.grammar.andPredicate, BinOp)
if not (__pass__) then
...
end, arity = 0, grammar = MixedAstCalc, name = 'eval'}), [AddOp] = OMeta.Rule({behavior = function (input)
local right, left, __pass__
return input:applyWithArgs(input.grammar.choice, function (input)
if not (input:applyWithArgs(input.grammar.object, nil, function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = MixedAstCalc, name = 'AddOp'}), [SubOp] = OMeta.Rule({behavior = function (input)
local right, left, __pass__
return input:applyWithArgs(input.grammar.choice, function (input)
if not (input:applyWithArgs(input.grammar.object, nil, function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = MixedAstCalc, name = 'SubOp'}), [MulOp] = OMeta.Rule({behavior = function (input)
local right, left, __pass__
return input:applyWithArgs(input.grammar.choice, function (input)
if not (input:applyWithArgs(input.grammar.object, nil, function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = MixedAstCalc, name = 'MulOp'}), [DivOp] = OMeta.Rule({behavior = function (input)
local right, left, __pass__
return input:applyWithArgs(input.grammar.choice, function (input)
if not (input:applyWithArgs(input.grammar.object, nil, function (input)
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = MixedAstCalc, name = 'DivOp'}), unknown = OMeta.Rule({behavior = function (input)
local opr, __pass__
return input:applyWithArgs(input.grammar.choice, function (input)
...
end, arity = 0, grammar = MixedAstCalc, name = 'unknown'})})
